        ...
        <form action="" method="POST" class="guestdetailpanelform">
            ...
            <div class="middle">
                <div class="guestinfo">
                    ...
                    <input type="text" name="CMND" id="seachcmnd" placeholder="Enter CMND" required>
                    <button type="button" class="btn btn-success" name="CMNDsearch" onclick="searchCMND()">Search</button>
