        ...
        <form action="" method="POST" class="guestdetailpanelform">
            ...
            <div class="middle">
                ...
                <div class="reservationinfo">
                    <h4>Add room</h4>
                    <select class="selectinput" id="room-type-selected" onchange="search_room(this)">
                    ...
                    <div id="display-list-room" style="overflow: auto;">
                        ...
                        foreach ($room_arr as $key => $value):
                            echo '<input type="checkbox" class="btn-check' . ' hideroom type' . $value["roomtype"] . '" id="room' . $value["id"] . '" name="room' . $value["id"] . '" autocomplete="off">';
                            echo '<label class="btn btn-outline-danger' . ' hideroom type' . $value["roomtype"] . '" id="room' . '" for="room' . $value["id"] . '" room' . $value["id"] . '>P.' . $value["roomnumber"] . '</label>';
                        //close your tags!!
                        endforeach;
                        ?>
